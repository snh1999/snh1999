...
|                                                                                                     Stats from WakaApi (WakaTime API)                                                                                                      |             WakaApi Overview (2026)              |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------: |
| ![wakatime stats](https://denvercoder1-github-readme-stats.vercel.app/api/wakatime?username=snh1999&api_domain=wakapi.dev&theme=chartreuse-dark&custom_title=Recent%20Stats%20from%20Wakapi&layout=compact&range=last_year&langs_count=10) | ![wakapi metrics](./metrics.plugin.wakatime.svg) |
...
<summary> 
    <img
        src="https://custom-icon-badges.demolab.com/badge/Stats_from_employment-grey?style=for-the-badge"
        alt="Future Project Plans and Progress"
    />
</summary>
...
- These stats were automatically getting updated upto 31 October, 2024. Following the deletion of the account, the static images are being shown. (the workflow was deleted with <a href="https://github.com/snh1999/snh1999/commit/4fd29a372e7777e186276b6e3fd511f437a879b1">this commit</a>)
